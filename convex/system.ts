...
const validateInternalKey = (key: string) => {
    ...
    if (!internalKey) {
        throw new Error("STRATUM_CONVEX_INTERNAL_KEY is not configured");
    }
...
// Used for agent to update conversation title based on context
...
export const deleteFile = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        // Recursively delete all file/folders and all descendants
