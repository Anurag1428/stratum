...
// StateField: Holds our suggestion in the editor.
// - create() : Returns the initial value when the editor loads
// - update() : Called on every transaction ( keystorke, etc) to potentially update the value 
...
class SuggestionWidget extends WidgetType {
    ...
    toDOM() {
        ...
        span.style.opacity = "0.4" // Ghost text appearence
...
const renderPlugin = ViewPlugin.fromClass(
    class {
        ...
        update(update: ViewUpdate) {
            ...
            // Rebuild decorations if doc changed,cursor moved, or suggestuion changed
            const shouldRebuild = 
