...
export const createScrapeUrlsTool = () => {
    return createTool({
        name: "scrapeUrls",
        description: 
            "Screpe content from URLs to get documentation or reference material. Use this when the user provide URLs or references external documentation. Returns markdown content from the scraped pages.",
        parameters: z.object({
            urls: z.array(z.string()).describe("Array or URLs to scrape for content"),
        }),
